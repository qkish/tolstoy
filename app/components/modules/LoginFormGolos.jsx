...
class LoginForm extends Component {
    ...
    render() {
        ...
        const title = loginBroadcastOperation ?
            ...
            translate('create_your_GOLOS_account_name');
        ...
        const form = (
            ...
            >
                ...
                <label className="LoginForm__label">{translate('golos_about')}{golosLink}</label>
                    <input type="text" className="LoginForm__login-input" required placeholder={translate('enter_username_golos')} ref="username"
