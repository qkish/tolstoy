...
class Settings extends React.Component {
  ...
  render() {
    ...
    const errorView = state.errorMessage ?
      <div
        className="alert alert-danger">{state.errorMessage}</div> : state.successMessage ?
        ...
        <div className="Settings__FieldsTabs__tab">
          <form onSubmit={this.handleUserFieldsSubmit}>
            ...
            <label>
              ...
              <input type="text" onChange={this.handleUserFirstNameChange}
                     value={state.first_name}
                     placeholder={translate('first_name')}/>
            </label>
            <label>
              <span>{translate('last_name')}</span>
              <input type="text" onChange={this.handleUserLastNameChange}
                     value={state.last_name}
                     placeholder={translate('last_name')}/>
            </label>
            <label>
              <span>{translate('city')}</span>
              <input type="text" onChange={this.handleUserCityChange}
                     value={state.city} placeholder={translate('city')}/>
            </label>
            <label>
              <span>{translate('birth_date')}</span>
              <input type="text" onChange={this.handleUserAgeChange}
                     value={state.age} placeholder={translate('birth_date')}/>
            </label>
            <label>
              <span>{translate('occupation')}</span>
              <textarea onChange={this.handleUserOccupationChange}
                        value={state.occupation}
                        placeholder={translate('occupation')}></textarea>
            </label>
            <label>
        ...
        <div className="Settings__FieldsTabs__tab">
          ...
          <form onSubmit={this.handleUserFieldsSubmit}>
            ...
            <label>
              ...
              <textarea onChange={this.handleLookingForChange}
                        value={state.looking_for}
                        placeholder={translate('looking_for')}></textarea>
            </label>
            
            {/* I Can */}
            <label>
              <span>{translate('i_can')}</span>
              <textarea onChange={this.handleICanChange} value={state.i_can}
                        placeholder={translate('i_can')}></textarea>
            </label>
        ...
        <div className="Settings__FieldsTabs__tab">
          <form onSubmit={this.handleUserFieldsSubmit}>
            ...
            <label>
              ...
              <input type="text" onChange={this.handleTargetDateChange}
                     value={state.target_date}
                     placeholder={translate('target_date')}/>
            </label>
            <label>
              <span>{translate('leverage')}</span>
              <input type="text" onChange={this.handleTargetPlanChange}
                     value={state.target_plan}
                     placeholder={translate('leverage')}/>
            </label>
            <label>
              <span>{translate('target_point_a')}</span>
              <input type="text" onChange={this.handleTargetPointAChange}
                     value={state.target_point_a}
                     placeholder={translate('target_point_a')}/>
            </label>
            <label>
              <span>{translate('target_point_b')}</span>
              <input type="text" onChange={this.handleTargetPointBChange}
                     value={state.target_point_b}
                     placeholder={translate('target_point_b')}/>
            </label>
        ...
        <div className="Settings__FieldsTabs__tab">
          <form onSubmit={this.handleUserFieldsSubmit}>
            ...
            <label>
              ...
              <input type="text" onChange={this.handleWebsiteChange}
                     value={state.website} placeholder={translate('website')}/>
            </label>
            <label>
              <span>{translate('instagram')}</span>
              <input type="text" onChange={this.handleInstagramChange}
                     value={state.instagram}
                     placeholder={translate('instagram')}/>
            </label>
            <label>
              <span>{translate('facebook')}</span>
              <input type="text" onChange={this.handleFacebookChange}
      ...
      currentFieldsBlock =
        <div className="Settings__FieldsTabs__tab">
          ...
          {state.background_image ?
            <img src={_urls.proxyImage(state.background_image)}
          ...
          <form onSubmit={this.handleUserFieldsSubmit}>
            ...
            <label>
              ...
              <input type="url" onChange={this.handleBackgroundImageChange}
                     value={state.background_image}
                     disabled={!props.isOwnAccount || state.loading}
                     placeholder={translate('add_background_image_url')}/>
            </label>
    ...
    return <div className="Settings">
      ...
      <ul className="menu Settings__tabs">
        <li role="presentation"
            className={currentTab == 'base' ? 'active' : ''}>
          <a id="base"
             onClick={this.tabsSelectHandle}>{translate('base_tab')}</a>
        </li>
        
        <li role="presentation"
            className={currentTab == 'target' ? 'active' : ''}>
          <a id="target"
             onClick={this.tabsSelectHandle}>{translate('target_tab')}</a>
        </li>
        <li role="presentation"
            className={currentTab == 'contacts' ? 'active' : ''}>
          <a id="contacts"
             onClick={this.tabsSelectHandle}>{translate('contacts_tab')}</a>
        </li>
        <li role="presentation"
            className={currentTab == 'more' ? 'active' : ''}>
          <a id="more"
             onClick={this.tabsSelectHandle}>{translate('more_tab')}</a>
        </li>
        <li role="presentation"
            className={currentTab == 'avatar' ? 'active' : ''}>
          <a id="avatar"
             onClick={this.tabsSelectHandle}>{translate('avatar_tab')}</a>
        </li>
        <li role="presentation"
            className={currentTab == 'background' ? 'active' : ''}>
          <a id="background"
             onClick={this.tabsSelectHandle}>{translate('background_tab')}</a>
        </li>
        <li role="presentation"
            className={currentTab == 'system' ? 'active' : ''}>
          <a id="system"
             onClick={this.tabsSelectHandle}>{translate('system_tab')}</a>
        </li>
