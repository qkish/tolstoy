...
class CategorySelectorTask extends React.Component {
    static propTypes = {
        // HTML props
        ...
        catsCurrent: React.PropTypes.string,
    ...
    render() {
        ...
        let tagsCurrent = this.props.catsCurrent;


        const categoryInput =
            <input type="hidden" {...cleanReduxInput(impProps)} ref="categoryRef" tabIndex={tabIndex} disabled={disabled} value={tagsCurrent} />
...
export default connect((state, ownProps) => {
    const trending = state.global.get('tags_idx').get('trending')
    // apply translations
